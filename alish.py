...
helpMessage =""" Alish Joker Bot v.2
[Id︎]
[Mid]
[Me︎]
[TL︎:「Text」]
...
wait = {
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"سلام از اینکه منو ادد کردین ممنون هستیم برای کنسل شدن در گروهاتون کلمه کنسل را به انگلیسی یا فارسی ارسال کنید صفحه من در لاین https://line.me/R/ti/p/%40hkl8562e",
    "lang":"JP",
    "comment":"سلام از اینکه منو ادد کردین ممنون هستیم برای کنسل شدن در گروهاتون کلمه کنسل را به انگلیسی یا فارسی ارسال کنید صفحه من در لاین https://line.me/R/ti/p/%40hkl8562e",
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
    "clock":True,
    "cName":"Alish Joker Bot v.2 ",
    "blacklist":{},
    "wblacklist":False,
    "dblacklist":False,
    "protectionOn":True
            ...
            if msg.contentType == 13:
               if wait["wblack"] == True:
                ...
                if msg.toType == 2:
                    ...
                    ki.updateGroup(X)
                    if wait["lang"] == "JP":
                        ki.sendText(msg.to,"Done Alish Joker Bot v.2")
                    else:
                ...
                if msg.toType == 2:
                    ...
                    kk.updateGroup(X)
                    if wait["lang"] == "JP":
                        kk.sendText(msg.to,"Done Alish Joker Bot v.2")
                    else:
                ...
                if msg.toType == 2:
                    ...
                    kc.updateGroup(X)
                    if wait["lang"] == "JP":
                        kc.sendText(msg.to,"Done Alish Joker Bot v.2")
                    else:
...
#-----------------------------------------------
                ...
                ki.sendText(msg.to,"Selamat datang di Alish Joker Bot v.2 Family Room")
